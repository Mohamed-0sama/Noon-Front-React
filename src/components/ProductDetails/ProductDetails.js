...
export default function ProductDetails() {
    ...
    useEffect(() => {
        const getProductbyId = async () => {
            //setLoading(true);
            await axios.get(`https://noon-ecommerce.herokuapp.com/api/products/find/${id}`).then(function (response) {
                // handle success
        ...
        <>
            <div className="container">
                <div className="row mt-5">
                    <div className="col-lg-5">
                        <img src={ImageUrl + product.imageSrc} alt={product.brand} height="400px" width="400px" />
                    </div>
                    <div className="col-lg-4">
                        ...
                        <div className="sameline">
                            ...
                            <p><a className="Rating" href="/#"> {/*product.rating.rate*/} </a> </p>
                        </div>

                        <div className="sameline">
                            <p> <span className="newprice"> EGP {product.price}</span><br />
          ...
          " alt="icon" className="img-fluid expressimg " />
                        ...
                        <div className="sameline">
                            ...
                            {product.quantity > 3 && <p> Quantity<span className="lowquaintityred text-primary"> {product.quantity}</span></p>}
                            {product.quantity <= 3 && product.quantity > 0 && <span className="lowquaintityred text-danger"> Low stock: only {product.quantity} left</span>}
                            {product.quantity === 0 && <span className="lowquaintityred text-danger"> Out of Stock</span>}
                        ...
                        <div className="box">
                            <div className="d-flex">
                                ...
                                <button className="btn btn-outline-dark mb-5 mt-2 me-2" onClick={() => handleMinus()}>
                                    <i className="fa fa-minus"></i>
                                </button>
                                <div className="text-center border border-dark rounded mb-5 mt-2 me-2 pt-1 h-70" style={{ width: "40px" }}>{quantityWanted}</div>
                                <button className="btn btn-outline-dark mb-5 mt-2 me-5" onClick={() => setquantityWanted(+quantityWanted + 1)}>
                                    <i className="fa fa-plus"></i>
                                </button>
                            </div>
                            {/* <!-- <div className="quantity whitebox"> 1 <p className="border-end-1"></p></div> --> */}
                            <div className="addtocart">
                                <button className="btn btn-lg text-center text-white w-100 " disabled={product.quantity < quantityWanted || product.quantity === 0} onClick={() => addCartProduct(product)}> Add To Cart</button>
                            </div>
                        </div><br />
            ...
            " alt="icon" className="img-fluid " />
                            ...
                            <div>
                                <p className="boldd">
                                    FREE RETURNS <br /><span className="hiddenfont">Get free returns on eligible items</span>
                                </p>
                            </div>
                        </div>
          ...
          " alt="icon" className="img-fluid" />
                            ...
                            <div>
                                <p className="boldd">
                                    TRUSTED SHIPPING <br /><span className="hiddenfont"> Free shipping when you spend <br />350 EGP and above </span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="d-flex">
                            ...
                            <div>
                                <p className="boldd">
                                    ...
                                    SECURE SHOPPING <br /> <span className="hiddenfont">Your data is always protected </span>
                                </p>
                            </div>
                        </div>
                    </div>
