...
export default function CartAside(props) {
    ...
    console.log(userId);
    const order = {
        userId: "555555",//localStorage.getItem
    ...
    const config = {
        ...
        headers: { token: `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYxOTQ1NGNkYzI0MGFhNzlkNDYxMGViNiIsImlzQWRtaW4iOnRydWUsImlhdCI6MTYzOTAxMDc5MywiZXhwIjoxNjM5MjY5OTkzfQ.nMhhcrgPQMmjYpYCl1JLsSr9d8yBo7Dd9QjZngl53uU` }
    }
    //console.log(order);
    ...
    const handleCheckOut = async () => {
        ...
        await axios.post(
            'https://noon-ecommerce.herokuapp.com/api/orders',
            order,
            config
            ...
            <div className="p-3 ms-5 col-md-12 rightsideBar">
                <div className="container-fluid  bg-light justify-content-evenly pt-3" style={{ border: "solid 0.5px lightgray" }}>
                    ...
                    <div className="row text-center p-4">
                            <button className="btn btn-primary text-white text-uppercase" style={{ width: "100%" }} onClick={handleCheckOut}>Checkout</button>
                    </div>
                </div>
