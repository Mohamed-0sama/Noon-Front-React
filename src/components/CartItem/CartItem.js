                ...
                <div className="chekout-cart d-flex flex-1 justify-content-between">
                    <div className="d-flex ">
                        ...
                        <div className="cart-content">
                            <div>
                                <p className="product-brand">{props.product.brand} <br />
                                    <span className="product-details">{props.product.title}
                                    </span>
                                </p>
                            </div>

                            <div>
                                <p className="shipping-duration"> Order in {props.product.OrderIn} <br />
                            ...
                            <div>
                                <p className="semi-hidden">
                                    ...
                                    <span className="semi-bold">
                                        <img src="https://z.nooncdn.com/s/app/com/noon/icons/warranty.svg" alt="product" className="img-fluid" />
                                        {props.product.warranty} year warranty </span>
                                </p>
                    ...
                    <div className="rightside">
                        <span className="semi-hidden">EGP <span className="bold">{props.product.price}</span></span>
                        <div /*className="dropdown btn-border"*/>
                            ...
                            <button className="btn btn-outline-dark" onClick={(p)=>props.handleAdd(props.product)}>
